...
export const Nav = ({
  ...
  return (
    <section className="flex col1-nav-con">
      ...
      >
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" width="31.827" height="28.927" viewBox="0 0 31.827 28.927">
      ...
      >
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" width="31.116" height="31.834" viewBox="0 0 31.116 31.834">
      ...
      <div onClick={logout} className="nav-con-li">
        <span><svg xmlns="http://www.w3.org/2000/svg" width="31" height="26.167" viewBox="0 0 31 26.167">
